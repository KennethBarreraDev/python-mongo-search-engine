...
def establecer_palabras_repetidas (coleccion, titulo, url, palabra1, ranking1, palabra2, ranking2, palabra3, ranking3, contenido):
    try:
...
def obtener_enlaces(coleccion, enlace_actual):
    ...
    if bs.title is not None:
        ...
        if len(lista_repetidas) == 6 and titulo:
            if len(texto_enlace)>450:
                texto_enlace = texto_enlace[0:450]
            establecer_palabras_repetidas(coleccion, titulo, enlace_actual, lista_repetidas[0], lista_repetidas[1], lista_repetidas[2], lista_repetidas[3], lista_repetidas[4], lista_repetidas[5], texto_enlace)
...
def almacenar_enlaces(coleccion, enlaces_encontrados):
    try:
        if enlaces_encontrados is not None:
